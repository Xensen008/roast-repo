          ...
          <div className="space-y-8 animate-fade-in">
            ...
            {generatedReadme && (
              <div className="glass border border-white/10 p-4 md:p-8 rounded-2xl backdrop-blur-lg shadow-2xl animate-fade-in mx-4">
                ...
                <p className="text-gray-500 text-xs md:text-sm mt-4 text-right">This is a generated README. If you find any placeholders or issues, fix them yourself, you duffer! 🥴</p>
              </div>
            )}
          </div>
        )}
